        ...
        >
          ...
          >
            ...
            >
              ...
              <Typography sx={{ color: '#ffffff', ml: 2 }}>ul. Rycerska 9, 41-902 Bytom</Typography>
            </Box>
            <Box
              sx={{
                display: 'flex',
            ...
            >
              ...
              <Typography sx={{ color: '#ffffff', ml: 2 }}>kontenery@tsl-silesia.com.pl</Typography>
            </Box>
          </Box>
          <Box
            sx={{
          ...
          <Box className="max-w-sm h-full bg-white shadow-lg p-6 flex flex-col">
            ...
            <Box className="flex flex-col space-y-4 mt-4">
              ...
              >
                ...
                <Typography sx={{ color: '#000', ml: 2 }}>ul. Rycerska 9, 41-902 Bytom</Typography>
              </Box>
              <Box
                sx={{
                  display: 'flex',
              ...
              >
                ...
                <Typography sx={{ color: '#000', ml: 2 }}>kontenery@tsl-silesia.com.pl</Typography>
              </Box>
